...
typedef struct {
	...
	__vo uint32_t FLTR;					/*!< I2C TRISE register,									Address offset: 0x24		*/
} I2C_RegDef_t;
...
typedef struct {
	...
	__vo uint32_t CR1;			/*!< USART Control rate register 1,							Address offset: 0x0C		*/
	__vo uint32_t CR2;			/*!< USART Control rate register 2,							Address offset: 0x10		*/
	__vo uint32_t CR3;			/*!< USART Control rate register 3,							Address offset: 0x14		*/
	__vo uint32_t GTPR;			/*!< USART Guard time and prescaler register 3,				Address offset: 0x18		*/
} USART_RegDef_t;
